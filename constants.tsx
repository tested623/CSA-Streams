...
export const ANIMATIONS: Animation[] = [
  ...
  },
  {
    ...
    rating: 'NR',
    duration: '1m 55s',
    videoUrl: 'https://go.screenpal.com/player/cOno0hn0YlY?ff=1&ahc=1&dcc=1&tl=1&bg=transparent&share=1&download=1&embed=1&cl=1',
    likes: 0,
    superlikes: 0,
    dislikes: 0,
    studio: 'Chickensoup',
  },
  {
    ...
    rating: 'NR',
    duration: '6m 18s',
    videoUrl: 'https://go.screenpal.com/player/cOno0Qn0YlK?ff=1&ahc=1&dcc=1&tl=1&bg=transparent&share=1&download=1&embed=1&cl=1',
    likes: 0,
    superlikes: 0,
    dislikes: 0,
    studio: 'Chickensoup',
  },
  {
    ...
    rating: 'NR',
    duration: '30s',
    videoUrl: 'https://go.screenpal.com/player/cOno0rn0YIE?ff=1&ahc=1&dcc=1&tl=1&bg=transparent&share=1&download=1&embed=1&cl=1',
    likes: 0,
    superlikes: 0,
    dislikes: 0,
    studio: 'Chickensoup',
  ...
  },
  {
    ...
    rating: 'NR',
    duration: '23s',
    videoUrl: 'https://go.screenpal.com/player/cOno00n0YIW?ff=1&ahc=1&dcc=1&tl=1&bg=transparent&share=1&download=1&embed=1&cl=1',
    likes: 0,
    superlikes: 0,
    dislikes: 0,
    studio: 'Ploto-Samir Studios',
  },
  {
    id: 11,
    title: 'The Great Mod',
    description: 'Gerald finds out about jennys mod.',
    thumbnailUrl: 'https://i.ibb.co/VYLGkvm5/Screenshot-2026-02-15-164730.png',
    heroImageUrl: 'https://i.ibb.co/2YWK6jx9/Screenshot-2026-02-15-164748.png',
    category: 'short-films',
    year: 2025,
    rating: 'XXX',
    duration: '50s',
    videoUrl: 'https://go.screenpal.com/player/cOno39n0YX7?ff=1&ahc=1&dcc=1&tl=1&bg=transparent&share=1&download=1&embed=1&cl=1',
    likes: 0,
    superlikes: 0,
    dislikes: 0,
    studio: 'Chickensoup',
